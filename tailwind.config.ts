  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        // SafeGrip custom colors
        "safety-yellow": "hsl(var(--safety-yellow))",
        "safegrip-blue": "hsl(var(--safegrip-blue))",
      ...
      keyframes: {
        ...
        "glow-pulse-blue": {
          "0%, 100%": { boxShadow: "0 0 20px hsl(197 93% 49% / 0.3)" },
          "50%": { boxShadow: "0 0 40px hsl(197 93% 49% / 0.5)" },
        },
        shimmer: {
      ...
      backgroundImage: {
        ...
        "hero-gradient": "linear-gradient(135deg, hsl(0 0% 0% / 0.7) 0%, hsl(0 0% 0% / 0.5) 100%)",
        "card-gradient": "linear-gradient(135deg, hsl(0 0% 100% / 0.08) 0%, hsl(0 0% 100% / 0.02) 100%)",
      },
    },
  },
